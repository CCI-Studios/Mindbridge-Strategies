  ...
  <table class="adminlist">
    ...
    <tbody>
      ...
      <tr class="<?php echo "row$k"; ?>">
				...
				<td class="k2Center">
					<?php if (JFile::exists(JPATH_SITE.DS.'media'.DS.'k2'.DS.'items'.DS.'cache'.DS.md5("Image".$row->id).'_XL.png')): ?>
					<a href="<?php echo JURI::root().'media/k2/items/cache/'.md5("Image".$row->id).'_XL.png';?>" class="modal"><img src="templates/khepri/images/menu/icon-16-media.png" alt="<?php echo JText::_('Preview image');?>" /></a>
					<?php endif; ?>
				</td>
